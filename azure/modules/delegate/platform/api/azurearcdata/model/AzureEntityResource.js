...
/**
 * The AzureEntityResource model module.
 * @module model/AzureEntityResource
 * @version 2023-01-15-preview
 */
class AzureEntityResource {
    /**
     * Constructs a new <code>AzureEntityResource</code>.
     * The resource model definition for an Azure Resource Manager resource with an etag.
     * @alias module:model/AzureEntityResource
    ...
    /**
     * Constructs a <code>AzureEntityResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AzureEntityResource} obj Optional instance to populate.
     * @return {module:model/AzureEntityResource} The populated <code>AzureEntityResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AzureEntityResource();
    ...
    /**
     * Validates the JSON data with respect to <code>AzureEntityResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AzureEntityResource</code>.
     */
 ...
 * @member {String} etag
 */
AzureEntityResource.prototype['etag'] = undefined;
 ...
 */
AzureEntityResource.prototype['systemData'] = undefined;
...
export default AzureEntityResource;
