...
class Transaction {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = TransactionProperties.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          TransactionProperties.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/TransactionProperties} properties
 */
Transaction.prototype['properties'] = undefined;
